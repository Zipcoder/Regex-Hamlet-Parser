...
public class HamletParserTest {
    ...
    @Test
    public void testChangeHamletToLeonMethod() {
        String replaced = hamletParser.replace("Hamlet", "Leon", hamletText);
        Assert.assertTrue(replaced.contains("Leon"));
        Assert.assertFalse(replaced.contains("Hamlet"));
    }

    @Test
    public void testChangeHoratioToTariqMethod() {
        String replaced = hamletParser.replace("Horatio", "Tariq", hamletText);
